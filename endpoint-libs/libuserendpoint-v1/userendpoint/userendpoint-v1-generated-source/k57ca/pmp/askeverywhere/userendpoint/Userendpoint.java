...
package k57ca.pmp.askeverywhere.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<k57ca.pmp.askeverywhere.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, k57ca.pmp.askeverywhere.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link k57ca.pmp.askeverywhere.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(k57ca.pmp.askeverywhere.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<k57ca.pmp.askeverywhere.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(k57ca.pmp.askeverywhere.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, k57ca.pmp.askeverywhere.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<k57ca.pmp.askeverywhere.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, k57ca.pmp.askeverywhere.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(k57ca.pmp.askeverywhere.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<k57ca.pmp.askeverywhere.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(k57ca.pmp.askeverywhere.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, k57ca.pmp.askeverywhere.userendpoint.model.User.class);
    }
